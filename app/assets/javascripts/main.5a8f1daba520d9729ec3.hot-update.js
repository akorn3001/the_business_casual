...
/***/ "./frontend/components/Presentational/article_form.jsx":
/*!*************************************************************!*\
  !*** ./frontend/components/Presentational/article_form.jsx ***!
  \*************************************************************/
...
var ArticleForm = function (_React$Component) {
  ...
  function ArticleForm(props) {
    ...
    _this.handleSaveForLater = _this.handleSaveForLater.bind(_this);
  ...
  _createClass(ArticleForm, [{
    ...
    value: function handlePublish(e) {
      ...
      this.props.requestCreateArticle(formDataObject).then(function () {
        _this3.setState({ title: "", body: "", imageFile: null });
      });
    }
  }, {
    key: 'handleSaveForLater',
    value: function handleSaveForLater(e) {
      var _this4 = this;
      ...
      this.props.requestCreateArticle(formDataObject).then(function () {
        _this4.setState({ title: "", body: "", imageFile: null });
      });
    }
  }, {
    key: 'handleFile',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'article-form-button form-submit', onClick: this.handleSaveForLater },
              'Save for Later!'
            ),
            _react2.default.createElement(
              'button',
...
//# sourceMappingURL=main.5a8f1daba520d9729ec3.hot-update.js.map